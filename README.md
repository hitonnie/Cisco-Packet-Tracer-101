...
<p>Email is a dital messages betweem users through computers. In the servers email services i added users and created passwords. Set the incoming and outcoming server to the Servers IP Address. Which users used to sign in to thier emails allowing them to send messages back and forth</p>
